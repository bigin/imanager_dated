...
class ImController
{
    ...
    {/*{{{*/
        ...
        return $this->imo->output($tpl, array('tr-class' => $class,
            ...
            'selected-editor' => @$def['type']=='textarea' ? 'selected="selected"' : '',
    ...
    {   /*{{{*/
        $tpls = ImModel::getTplKit('catselector');
        $cfile = ImModel::getPref();
        $tvs = '';
