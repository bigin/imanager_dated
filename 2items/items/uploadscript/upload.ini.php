...
$par_systeminfo = array(
    ...
    'classesdir'        => 'model',
    // Contains the relative path to temporery file directory.
    // For generating <img />-tag and 'src'-attribut value.
    // Please note that the final slash is expected!
    'tmpurl'            => 'tmp/',
    // A Default inputname if “genOutput()“ called without argument.
    // This value will be invalid by calling the “genOutput('myFile')“ function with argumet
    'form_input_name'   => 'myfile',
    // Define HTML-atributes to remove these automatically when element values are empty.
    'systvs'            => 'class, id, name, content, xml:lang, lang',
    // Session authentification. For activate enter `On` value.
    'sess_auth'         => '',
);
...
$par_template = array(
    ...
    'formtemplate' => array(
        ...
        'win_left_pos'             => 100,
        'win_top_pos'              => 100,
        // Text input css class & id if needed
        'form_input_class'         => '',
    ...
    'windowcontent'  => array(
        ...
        // CSS-class & id of the <div> container and form elements like inputs, etc.
        'form_cont_elements_class' => 'inputcont',
        'form_cont_elements_id'    => '',
        // You can set there css class & id of the div tag, that contains images
        'multi_data_cont_class'    => 'multicont',
        'multi_data_cont_id'       => '',
        // Name of the input type file
        'input_name_file'          => 'inputnam',
        // Maximum file size of the form input his value can be easily manipulated, 
        // instead, please use 'maxsize_mainimg' parameter below “filter section“
        'html_maxfilesize'         => '',
        'lang_info_display'        => '',
        'lang_select_image'        => 'Click “Upload Image” to include a featured image for your article.',

    ),

    'windowimageloop' => array(

        // css classes & id's, if required
...
$par_imagefilter = array(
    ...
    // Search pattern and file extension for the file names.([[+uid]]-TV inclusive) 
    'files_pattern'          => '{*[[+uid]]*.gif, *[[+uid]]*.jpg, *[[+uid]]*.jpeg, *[[+uid]]*.png}',
    // Allowed character for file names
    ...
    // Sample: '/var/www/hosts/myhostdir/httpdocs/upload/tmp/'
    // If you're not sure what your absolute path is, check the phpinfo() DOCUMENT_ROOT directive. 
    // NOTE: As 'tmpdir' parameter value you have to enter a slash '/' as the final character.
    'tmpdir'                 => 'tmp/',
    ...
    // Value can be entered in 1, 2, 3, 4, ... -hour format
