...
function i18n_gallery_cycle_header($gallery) {
  ...
  if (i18n_gallery_check($gallery,'jquery') && i18n_gallery_needs_include('jquery.js')) {
    //echo '<script type="text/javascript" src="'. i18n_gallery_site_link().'plugins/i18n_gallery/js/jquery-1.4.3.min.js"></script>';
...
?>
      <a class="prev" href="<?php i18n_gallery_pic_link($gallery,$pic>0 ? $pic-1 : $count-1); ?>"><img alt="" src="<?php echo $SITEURL; ?>plugins/i18n_gallery/images/cycle/prev.png"/></a>
      <a class="next" href="<?php i18n_gallery_pic_link($gallery,$pic<$count-1 ? $pic+1 : 0); ?>"><img alt="" src="<?php echo $SITEURL; ?>plugins/i18n_gallery/images/cycle/next.png"/></a>
    </div>
