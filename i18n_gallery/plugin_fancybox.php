...
?>
  ...
  <p>
    ...
    <!--
    <p id="fancybox-juris-test">
    <label for="fancybox-juristest">Juri's Test</label>
    <input type="text" class="text" id="fancybox-juristest" name="fancybox-juristest" value="<?php echo @$gallery['juristest']; ?>" style="width:5em"/>
    -->
  </p>
  </p>
